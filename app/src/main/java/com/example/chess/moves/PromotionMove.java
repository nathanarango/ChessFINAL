...
public class PromotionMove  extends Move{
    ...
    public PromotionMove(int startPosition, int endPosition, int previousEnPassantTile, boolean[] previousCastleRights, int previousHalfMoveCount, int promotionPieceNum, int pieceTaken) {
